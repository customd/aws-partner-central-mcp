...
( printf '%s\n' "$INIT"; sleep 3 ) | env AWS_SSO_START_URL="https://example.awsapps.com/start" AWS_SSO_ACCOUNT_ID='${user_config.sso_account_id}' AWS_SSO_ROLE_NAME='${user_config.sso_role_name}' PARTNER_CENTRAL_DEFAULT_CATALOG='${user_config.default_catalog}' NODE_ENV=production node /tmp/pc106/server/index.js
```
