...
2. Cut a **GitHub Release** and **attach `dist/aws-partner-central.mcpb`** as a release asset. Tag the release to match the manifest `version` (currently `1.0.0`).
...
each GitHub Release to match (currently `1.0.0`). Claude Desktop uses the manifest
